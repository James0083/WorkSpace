...
public class MyGui2 extends JFrame {
	...
	JPanel p = new JPanel() {
		...
		public Insets getInsets() { //Anonymous Class
	...
	public MyGui2() {
		...
		can = new Canvas();//도화지 역할을 하는 컴포넌트. 사이즈 주고, 배경색 줘야 확인가능
		can.setSize(200,200);
		...
		//리스너 부착----- 이름없는 로컬 클래스
		//Anonymous class로 이벤트 핸들러 구성해본다
