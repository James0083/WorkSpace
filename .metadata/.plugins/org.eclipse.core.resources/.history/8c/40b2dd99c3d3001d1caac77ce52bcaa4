...
//		pC.add(pWhite = new JPanel(), "White");
	...
	public void actionPerformed(ActionEvent e){ //[3]
		...
		else if(obj==pSearch.btSearch) {
			ArrayList<Recipe> Srcp = this.searchRecipe(pSearch.tfSearch.getText());
			for(Recipe rcp:Srcp) {
				pSearch.taSearch.append(rcp.RecipeToString());
			}
...
//			Pot = selected;
	...
	public ArrayList<Recipe> searchRecipe(String str) {
		...
		pSearch.taSearch.append("--Searching--");
		//보여지는 목록에서 선택
		/*
		int n = 0;
		while(true) {
